    ...
    <div>
      ...
      <div className='text-white text-center m-5'>
        ...
        <div className='flex flex-col md:flex-row sm:flex-row' style={{ justifyContent: "space-around" }}>
          ...
          <div className='lg:w-1/2 mt-5 md:w-full sm:w-full'>
            ...
            <p className='m-5 font-bold'>achieve your diet and fitness resolutions for 2024</p>
          </div>
          <div className='lg:w-1/2 mt-5 md:w-full sm:w-full'>
      ...
      {/* <div className='w-10/12  m-auto mt-10'> */}
        ...
        {/* <div className='flex m-10 '>
          ...
          <div>
            <h1 className='text-white font-bold text-2xl'>Abinesh</h1>
        ...
        {/* <div className='flex m-10 '>
          ...
          <div>
            <h1 className='text-white font-bold text-2xl'>Yogesh</h1>
            ...
            <div className="flex items-center m-2">
              ...
              <svg aria-hidden="true" className="w-5 h-5 text-gray-300 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Fifth star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
              <svg aria-hidden="true" className="w-5 h-5 text-gray-300 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Fifth star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
              <p className='pl-2 text-white'>Aug 12, 2024 05:02 PM</p>
            </div>

            <h1 className='text-white'>GymBuddy transform is the epitome of cheating and looting. Horrible product with absolutely no value adds whatsoever. The only good thing going for Cult is their sales team. Having said that, it is the most shamelessly dishonest sales team I have ever encountered.</h1>
          </div>
        ...
        {/* <div className='flex  m-10'>
          ...
          <div>
            <h1 className='text-white font-bold text-2xl'>Aman</h1>
            ...
            <div className="flex items-center m-2">
              ...
              <svg aria-hidden="true" className="w-5 h-5 text-gray-300 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Fifth star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
              <svg aria-hidden="true" className="w-5 h-5 text-gray-300 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Fifth star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
              <p className='pl-2 text-white'>Sep 17, 2024 06:47 PM</p>
            </div>

            <h1 className='text-white'>I've been using GymBuddy for a few months now, and overall, I've had a positive experience with the app. The workouts are challenging but not overwhelming, and I appreciate the variety of classes offered, from yoga to HIIT to strength training.</h1>
          </div>
        </div> */}
      {/* </div> */}
