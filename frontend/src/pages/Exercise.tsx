...
function Exercise() {
  ...
  return (
    <div className="text-white mr-5 ml-5 m-auto mb-40">
      ...
      <p className="text-gray-600 mb-4 mx-20 text-xl">
        This workout includes a variety of exercises targeting different muscle
        groups. Follow the steps below to perform each exercise correctly. These
        exercises are designed to improve strength, flexibility, and overall
        fitness. Make sure to warm up before starting the workout and listen to
        your body to prevent any injuries. Remember to breathe properly and
        maintain proper form throughout the exercises. If you have any
        underlying health conditions or concerns, consult with a healthcare
        professional before engaging in this workout routine. Enjoy your workout
      ...
      {products.length !== 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 gap-y-10 mt-10">
          {products.map((exercise, i) => (
            ...
            >
              ...
              {exercise.target && (
                <div>
                  <h3 className=" font-medium text-teal-400 inline">
                    Target Muscles 💪
                  </h3>
                  {exercise.target.Primary && (
                    <div className="mb-2">
                      <span className=" text-sm font-medium text-[#4ffc15]">
                        Primary:{" "}
                      </span>
                      <span>{exercise.target.Primary.join(", ")}</span>
                    </div>
        ...
        <div className="flex items-center justify-center flex-col gap-4">
          <h1 className="mt-4 text-2xl font-bold text-teal-400 text-center  ">
            No exercises available. Add workout exercises to get started!
          </h1>
          <button
            onClick={() => {
