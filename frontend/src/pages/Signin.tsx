    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        axios.post(`http://localhost:5000/user/login`, formdata)
            .then((res) => {
                ...
                localStorage.setItem("gymbuddyuser", res.data.username)
                // alert(res.data.msg)
        ...
        <div className="flex items-center justify-center min-h-screen  text-black" >
            ...
            >
                ...
                <div className="flex flex-col justify-center p-8 md:p-14 text-white">
                    <span className="mb-3 text-4xl font-bold text-center ">Welcome back to GymBuddy</span>
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        >"Don’t give up on your dreams,<br /> or your dreams will give up on you." <br /> Be Fit!!
                        </span>
                    </div>
                </div>
            </div >
